...
type HomeDocumentDataSlices2Slice = AlternateGridSlice;
...
interface HomeDocumentData {
   ...
   * Hello new tab field in *Home*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: home.hello_new_tab
   * - **Tab**: Test Tab
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */;
  hello_new_tab: prismic.KeyTextField;
   ...
   * - **Placeholder**: *None*
   * - **API ID Path**: home.posts
   * - **Tab**: Test Tab
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  posts: prismic.ContentRelationshipField<"posts">;
